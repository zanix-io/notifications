 ...
 * `templates/provider.ts`). Also self-registers this package's own `mail` trigger-action job
 * descriptor with `@zanix/database`'s `registerTriggerActionJob` (`providers/trigger-mail.core.ts`)
 * — `@zanix/core` drains it and performs the actual job registration. It exports nothing by
 * value; import it alongside the root `@zanix/notifications` entrypoint.
 *
 * @module
 */
...
export * from './providers/trigger-mail.core.ts'
